...
wchar_t * utf8towchar_convert(const char * s)
{
   size_t inputLen = strlen(s);
   size_t outputLen = utf8towchar(s, inputLen, NULL, 0);

   wchar_t * res = (wchar_t *) malloc(outputLen * sizeof(wchar_t));

   utf8towchar(s, inputLen, res, outputLen);
